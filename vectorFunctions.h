...
/////////////////////////////////////////
//  BP Chebyshev. 0.04 Hz to 0.5 Hz, Order 6
////////////////////////////////////////
...
Z domain Poles
z = 0.943725 + j -0.126880
z = 0.943725 + j 0.126880
z = 0.842607 + j -0.284957
z = 0.842607 + j 0.284957
z = 0.983269 + j -0.078452
z = 0.983269 + j 0.078452
z = 0.750106 + j -0.505449
z = 0.750106 + j 0.505449
z = 0.994321 + j -0.062222
z = 0.994321 + j 0.062222
z = 0.705411 + j -0.657488
z = 0.705411 + j 0.657488
***************************************************************/
#define NtapChebOrder6 81

//float fir(float NewSample) {
const float Cheb_FIRCoefOrder6[NtapCheb] = {
		-0.00587404980035581990,
		-0.00996406935449545980,
		-0.01164829217226453200,
		-0.01002214354276122700,
		-0.00596787724692267060,
		-0.00184679747697790190,
		-0.00033100147706114307,
		-0.00294645356810040950,
		-0.00911982792517568480,
		-0.01631436361468473200,
		-0.02127855437756715600,
		-0.02179980502126784000,
		-0.01800772572579285900,
		-0.01243802634814989600,
		-0.00870705146807819980,
		-0.00944061830800048410,
		-0.01460533779288349600,
		-0.02127912671043041100,
		-0.02516315275007191200,
		-0.02313482706213114100,
		-0.01542593723925672800,
		-0.00604107079229978300,
		-0.00089279942997426312,
		-0.00442915016567449300,
		-0.01656167664916299200,
		-0.03182139293293908400,
		-0.04166354161511019700,
		-0.03911806165439391000,
		-0.02343184251516823600,
		-0.00190954279870021620,
		0.01272846181326753300,
		0.00887332224580615960,
		-0.01651662781896121700,
		-0.05362366640946325500,
		-0.08176660045770436900,
		-0.07789299775288054100,
		-0.02825864333969092500,
		0.06228891844026503800,
		0.16878290585415032000,
		0.25469086738544200000,
		0.28771480643447667000,
		0.25469086738544200000,
		0.16878290585415032000,
		0.06228891844026503800,
		-0.02825864333969092500,
...
class CBPCheb1t012FilterOrder6 : public CFilter
{
public:
	CBPCheb1t012FilterOrder6();
	~CBPCheb1t012FilterOrder6();
};
